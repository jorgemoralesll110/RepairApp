...
public class Main {
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Jorge", "Morales Llerandi", new Phone("928112233"));
        Customer customer2 = new Customer("Raquel", "Almeida Quesada", new Phone("928445566"));
        ...
        serviceManager.getTechnicians().get(0).setName("Antonio Garcia");

        // vi. Pagar el servicio creado en el punto iv
        Payment payment = new Payment(new Date(2024 - 12 ), 100);
        service.pay(payment);
